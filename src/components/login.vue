  ...
  <div class="main-container">
    <div>
      <div class="box-container">
        ...
        <div class="form-fields">
          <button class="signIn" name="commit" type="submit" @click="getData">
            Accéder aux données
          </button>
        </div>
      </div>
...
export default {
  ...
  methods: {
    LoginGoogle() {
      ...
      setTimeout(function(){ window.location.href="http://localhost:8072/login"; }, 3000);

      console.log('login');
    },
    getData() {
      document.getElementById('spreadsheetId').innerHTML = document.getElementById("id_doc").value;
      document.getElementById('get_data_excel').click();
      console.log('get_data_excel');
    },
  }
};
</script>
